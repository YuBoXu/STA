...
<ul id="scene" style="padding: 0;margin: 0" class="fullImg">
    ...
    <li class="layer fullImg" data-depth="0.00"><img src="img/personInfo/arrow.png"
                                                     style="top: 20%;left: 60%;position: fixed;z-index: 10;cursor: pointer"
                                                     id="more"></li>
</ul>

<div class="content">
    <p style="text-align: center"><img id="avatar"
...
<script>
    ...
    $("#more").click(function () {
        window.location.href = "morePersonInfo";
    })
</script>
</html>
