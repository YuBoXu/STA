    ...
    e.fn.fullpage = function (W) {
        ...
        function ce() {
            ...
            if (!W.autoScrolling || W.scrollBar) {
                for (var i = $.scrollTop(), a = 0, s = t.abs(i - o.querySelectorAll(y)[0].offsetTop), l = o.querySelectorAll(y), r = 0; r < l.length; ++r) {
        ...
        function be(e) {
            var n = {};
            return W.autoScrolling && !W.scrollBar ? (n.options = {top: -e.dtop}, n.element = s) : (n.options = {scrollTop: e.dtop}, n.element = "html, body"), n
        }
        ...
        function ze(n, o) {
            ...
            } else n.animate({scrollLeft: t.round(i.left)}, W.scrollingSpeed, W.easing, function () {
                v()
            });
        ...
        function Ie(e) {
            ...
            return e.removeClass(u), e.css({"-webkit-transition": n, transition: n})
        }
        ...
        function tn(e) {
            if (W.recordHistory)location.hash = e; else if (Mn || Bn)history.replaceState(i, i, "#" + e); else {
        ...
        function vn(e) {
            if (W.scrollBar)Rn.scrollTop(e); else if (W.css3) {
        ...
        function gn(e, n, o) {
            switch (n) {
                ...
                case"right":
                    ...
                    break;
                case"all":
                    "m" == o ? Cn.setAllowScrolling(e) : Cn.setKeyboardScrolling(e)
            }
        }
        ...
        function yn() {
            W.continuousVertical && (W.loopTop || W.loopBottom) && (W.continuousVertical = !1, xn("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), W.scrollBar && W.scrollOverflow && xn("warn", "Option `scrollBar` is mutually exclusive with `scrollOverflow`. Sections with scrollOverflow might not work well in Firefox"), W.continuousVertical && W.scrollBar && (W.continuousVertical = !1, xn("warn", "Option `scrollBar` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), e.each(W.anchors, function (n, o) {
        ...
        In.m = {up: !0, down: !0, left: !0, right: !0}, In.k = e.extend(!0, {}, In.m);
        var Hn, On, Vn, Yn, Un, Wn, Xn = e.extend(!0, {}, W);
        e(this).length && K();
        var Nn = !1;
        $.on("scroll", ce);
